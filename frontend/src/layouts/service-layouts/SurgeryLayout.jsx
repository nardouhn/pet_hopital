  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-16">
      ...
      <div className="grid md:grid-cols-2 gap-10 items-start mb-4">
        ...
        <img src={service.image} alt="Surgery Service" className=" shadow-lg" />
      </div>

      <p className="text-[31px] font-md italic text-gray-800">
        Được thực hiện bởi đội ngũ bác sĩ giàu kinh nghiệm cùng hệ thống trang
        thiết bị hiện đại, mỗi ca phẫu thuật tại Petorium đều là sự kết hợp giữa
        kỹ thuật chuyên môn vững vàng và tấm lòng tận tâm.
      </p>

      <p className="mt-8 font-bold text-[31px]">Chúng tôi cung cấp:</p>
      ...
      <p className="mt-6 text-[30px] italic font-semibold">{service.commit}</p>
